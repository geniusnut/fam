...
public class FloatingActionsMenu extends ViewGroup {
	...
	private void init(Context context, AttributeSet attributeSet) {
		...
		mAddButtonSize = attr.getInt(R.styleable.FloatingActionsMenu_fab_addButtonSize, 0);
	...
	private void createAddButton(Context context) {
		mAddButton = new FloatingActionButton.Builder(context)
				.withDrawable(createLikeDrawable(context, true))
				.withSize(64) // dp
		...
		addView(mAddButton, mAddButton.mParams);
	}
	public static Drawable createLikeDrawable(Context context, boolean clicked) {
		final Resources res = context.getResources();
		final int size = (int) (res.getDisplayMetrics().density * 36);
		return SVG.getDrawable(res, clicked ? R.raw.ic_favorite_on : R.raw.ic_favorite_off, context.getResources().getColor(android.R.color.holo_blue_light), size);
	}
